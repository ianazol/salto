 ...
 *
 * ```js
 * var iControl = angular.module('iControl', []);
 * iControl.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://iControl.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://iControl.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * ```
 *  angular.module('iControl', []).config(function($sceDelegateProvider) {
 ...
 *      'http://iControl.example.com/clickThru**'
 *    ]);
 *  });
 * ```
 */
 ...
 * <file name="index.html">
 *   <div ng-controller="iControlController as myCtrl">
 ...
 *
 *   mySceApp.controller("iControlController", function iControlController($http, $templateCache, $sce) {
 *     var self = this;
 ...
 *
 * ```
 * angular.module('iControlWithSceDisablediControl', []).config(function($sceProvider) {
